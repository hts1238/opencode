  ...
  const controller = createPromptInputV2Controller({
    ...
    view: {
      ...
      submit: {
        ...
        onForceSubmit: () => {
          if (!working()) return void submission.handleSubmit(new Event("submit"), { queue: false })
          if (blank()) return void submission.abort()
          void submission
            .abort({ pauseQueue: false })
            .then(() => submission.handleSubmit(new Event("submit"), { queue: false }))
        },
